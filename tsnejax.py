...
Inside the container: A simple Flask app
from flask import Flask, request, jsonify

# Ensure that compute_low_dimensional_embedding is properly defined or imported
# from your_module import compute_low_dimensional_embedding
...
def compute_embedding():
    try:
        ...
        n_iter = content.get('n_iter', 1000)
